...
const MovieHero = () => {
    ...
    // ? check that either the movie having genres variable if it is map into it
    ...
    return (
        <>
            <div>
                ...
                {/* it contain the big bannar image */}
                ...
                <div className='relative hidden w-full lg:block' style={{ height: "30rem" }}>
                    ...
                    <img src={`https://image.tmdb.org/t/p/original${movie.backdrop_path}`} alt="backgrap poster"
